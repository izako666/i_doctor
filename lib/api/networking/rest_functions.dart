...
Future<Response> logIn(String email, String password) async {
  Dio dio = getRepo.Get.find<DioController>().dio;
  ...
  Response resp = await dio.post(url,
      ...
      options: Options(headers: {
        'Authorization':
            'Bearer ${getRepo.Get.find<AuthController>().masterAuthToken}',
...
Future<Response> getCategories() async {
  ...
  Response resp = await dio.get(url,
      options: Options(headers: {
        'Authorization':
            'Bearer ${getRepo.Get.find<AuthController>().getAuthToken()}',
        'Accept': 'application/json'
      }));
